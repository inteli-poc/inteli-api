...
module.exports = function () {
  const doc = {
    GET: buildValidatedJsonHandler(order.getDeliveryStatus, {
      ...
      parameters: [
        {
            description: 'Type of the data to get, monthly or total',
            in: 'path',
            required: true,
            name: 'type',
        ...
        {
            description: 'Persona requesting the data, buyer or supplier',
            in: 'path',
            required: true,
            name: 'type',
            allowEmptyValue: false,
