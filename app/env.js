...
const vars = envalid.cleanEnv(
  process.env,
  {
    ...
    PORT: envalid.port({ default: 80, devDefault: 7000 }),
    ...
    DSCP_API_PORT: envalid.port({ devDefault: 4001 }),
    LOG_LEVEL: envalid.str({ default: 'info', devDefault: 'debug' }),
    DB_HOST: envalid.host({ devDefault: 'localhost' }),
    DB_PORT: envalid.port({ default: 6432 }),
    ...
    IDENTITY_SERVICE_PORT: envalid.port({ devDefault: 4002 }),
  },
  {
    strict: true,
  }
